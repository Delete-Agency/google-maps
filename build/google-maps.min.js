...
/*!******************!*\
  !*** ./index.js ***!
  \******************/
/*! exports provided: GoogleMap, GoogleMarker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _src_google_map__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/google-map */ "./src/google-map.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "GoogleMap", function() { return _src_google_map__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _src_google_marker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/google-marker */ "./src/google-marker.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "GoogleMarker", function() { return _src_google_marker__WEBPACK_IMPORTED_MODULE_1__["default"]; });
...
/* harmony import */ var _google_marker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./google-marker */ "./src/google-marker.js");
...
function () {
  ...
  _createClass(GoogleMap, [{
    key: "_getMap",
    value: function () {
      var _getMap2 = _asyncToGenerator(
      /*#__PURE__*/
            ...
            switch (_context.prev = _context.next) {
              case 0:
                if (this.initPromise === null) {
                  loadScriptPromise = this.options.initPromise ? this.options.initPromise() : Promise.resolve();
                  this.initPromise = loadScriptPromise.then(function () {
    ...
    key: "getMapInstance",
    value: function () {
      var _getMapInstance = _asyncToGenerator(
      /*#__PURE__*/
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", this._getMap());
      ...
      function getMapInstance() {
        return _getMapInstance.apply(this, arguments);
      }
    ...
    key: "_updateMarkers",
    value: function _updateMarkers(map, markers) {
      var newMarkersByIds = this._getMarkersById(markers);

      var newMarkersIds = Object.keys(newMarkersByIds);

      var markersIdsToRemove = this._getMarkersIdsToRemove(newMarkersIds);

      if (markersIdsToRemove.length > 0) {
        this._removeMarkersByIds(markersIdsToRemove);
      }

      var markersToAdd = this._getMarkersToAdd(newMarkersByIds);
    ...
    key: "_getMarkersById",
    value: function _getMarkersById(markers) {
      var _this3 = this;

      return markers.reduce(function (result, marker) {
        result[_this3._getMarkerId(marker)] = marker;
        return result;
      }, {});
    }
  }, {
    key: "_addMarkers",
    value: function _addMarkers(markers, map) {
      var _this4 = this;
      ...
      markers.forEach(function (marker) {
        var id = _this4._getMarkerId(marker);

        newMarkers[id] = _this4._createMarker(id, marker, map);
      });
      this.markersById = _objectSpread({}, this.markersById, {}, newMarkers);
    }
    /**
    ...
    key: "_fitCurrentMarkers",
    value: function _fitCurrentMarkers(map) {
      var bounds = new google.maps.LatLngBounds();
      var currentMarkers = Object.values(this.markersById);
    ...
    key: "_removeMarkersByIds",
    value: function _removeMarkersByIds(ids) {
      var _this5 = this;

      ids.forEach(function (id) {
        var marker = _this5.markersById[id];
        marker.destroy();
      });
      this.markersById = Object.keys(this.markersById).filter(function (id) {
        return !ids.includes(id);
      }).reduce(function (result, id) {
        result[id] = _this5.markersById[id];
        return result;
      }, {});
    }
  }, {
    key: "_createMarker",
    value: function _createMarker(id, marker, map) {
      var options = {
        id: id,
        map: this,
        mapInstance: map,
      ...
      if (this.options.createMarker) {
        ...
        return new _google_marker__WEBPACK_IMPORTED_MODULE_0__["default"](options);
      }
    }
  }, {
    key: "_getMarkersToAdd",
    value: function _getMarkersToAdd(newMarkersByIds) {
      var currentMarkersIds = this._getCurrentMarkersIds();

      return Object.keys(newMarkersByIds).reduce(function (result, newMarkerId) {
    ...
    key: "_getMarkersIdsToRemove",
    value: function _getMarkersIdsToRemove(newMarkersIds) {
      return this._getCurrentMarkersIds().reduce(function (result, id) {
    ...
    key: "_getCurrentMarkersIds",
    value: function _getCurrentMarkersIds() {
      return Object.keys(this.markersById);
    }
  }, {
    key: "_getMarkerPosition",
    value: function _getMarkerPosition(marker) {
    ...
    value: function _getMarkerId(marker) {
      ...
      if (marker.id) {
        ...
        if (position.lat && position.lng) {
          id = "".concat(position.lat, ",").concat(position.lng);
        }
      }
    ...
    key: "getMarkerByConfig",
    value: function getMarkerByConfig(marker) {
    ...
    key: "fitCurrentMarkers",
    value: function () {
      var _fitCurrentMarkers2 = _asyncToGenerator(
      /*#__PURE__*/
      ...
      function fitCurrentMarkers() {
        return _fitCurrentMarkers2.apply(this, arguments);
      }

      return fitCurrentMarkers;
    }()
  }, {
    key: "getCurrentMarkersCount",
    value: function getCurrentMarkersCount() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return GoogleMarker; });
...
function () {
  ...
  _createClass(GoogleMarker, [{
    key: "_getGoogleMarkerOptions",
    value: function _getGoogleMarkerOptions() {
      return _objectSpread({}, this.markerOptions, {
    ...
    key: "getMarkerInstance",
    value: function getMarkerInstance() {
    ...
    value: function onStateChange(cb) {
      ...
      return function () {
        _this.onStateChangeCallback = null;
      };
    }
  }, {
    key: "_onClick",
    ...
    value: function fitPopup() {
      ...
      if (this.popup) {
        setTimeout(function () {
          ...
          var targetElement = _this2.popupElement;

          if (getPopupContent) {
            targetElement = getPopupContent(_this2.popupElement);
          }
          ...
          _this2.mapInstance.panToBounds(bounds, {
